...
const NAV_ITEMS = [
  ...
  { href: "/order-history", label: "History",   Icon: HistoryOutlinedIcon },
            ...
            <Tooltip key={href} title={label} placement="right" arrow>
              <Box
                ...
                sx={{
                  ...
                  "&:hover": { backgroundColor: "#f1f8f1", border: "1.5px solid #c8e6c9" },
                }}
              >
                <Icon sx={{ fontSize: 22, color: isActive ? "#2E7D32" : "#9e9e9e", transition: "color 0.18s" }} />
                <Typography
                  sx={{
            ...
            >
              ...
              {isActive && (
                <Box sx={{
                  ...
                  backgroundColor: "#2E7D32", mb: 0.25,
                }} />
              )}
              <Icon sx={{ fontSize: 22, color: isActive ? "#2E7D32" : "#9e9e9e", transition: "color 0.18s" }} />
              <Typography
